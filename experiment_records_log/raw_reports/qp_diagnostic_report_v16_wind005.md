...
- Feasibility rate: `99.2554%`
- Infeasibility rate: `0.7446%`
- Infeasible samples: `610 / 81920`
...
- soft CBF residual > tol: `4.6973%`
- CLF residual > tol: `30.5432%`
- box residual > tol: `0.7446%`

Dominant family among infeasible/binding samples:

- hard CBF dominant: `0.0000%`
- soft CBF dominant: `10.8808%`
- CLF dominant: `87.2315%`
- box dominant: `1.8877%`
...
- CLF dominant: `13.1148%`
- box dominant: `86.8852%`

Dominant family across all samples:

- hard CBF dominant: `54.2188%`
- soft CBF dominant: `9.3127%`
- CLF dominant: `35.6067%`
- box dominant: `0.8618%`

## Physical Distance And D_t

- Mean physical hard-barrier h over all samples: `2.555453`
- Min physical hard-barrier h over all samples: `-0.102364`
- Mean physical hard-barrier h when infeasible: `10.792696`
- Min physical hard-barrier h when infeasible: `0.771866`
- Mean obstacle distance: `1.447923 m`
- Min obstacle distance: `0.185839 m`
- Mean D_t used: `1.465886`
- Mean D_t_curr: `1.609366`
- Mean D_t_floor: `0.143438`
- Mean D_t / |h| ratio: `1.147247`
- Mean D_t / actual-wind-only bound ratio: `0.256424`
- D_t cap active rate: `28.1384%`

## CLF Cost Audit

- CLF cost active rate, t_clf > tol, diagnostic only: `80.5579%`
- CLF cost mean when active: `8.153342`
- CLF cost p95 when active: `20.625994`
- Mean t_clf: `6.568158`
- Max t_clf: `98.494019`
...
- Mean relative speed: `1.566921 m/s`
- Fraction with relative speed < 0.1 m/s: `0.4675%`
- Mean |psi1|: `12.446208`
- Mean |psi2|: `32.917091`
- Mean |psi2| at rel_speed < 0.1 m/s: `9.482644`
...
1. `Suspect 2: D_t over-conservative vs wind/h` score `0.2294`
2. `Suspect 3: low-speed HOCBF numerical fragility` score `0.1897`
