# QP Diagnostic Report V17.5

## Scope

RL hyperparameter tuning is suspended. This report verifies the V17.5 adaptive shield: fixed stage-limit wind input, recalibrated cap anchors, and Softplus soft-min D_t clamping.
...
- Feasibility rate: `99.2456%`
- Infeasibility rate: `0.7544%`
- Infeasible samples: `618 / 81920`
...
- soft CBF residual > tol: `5.0439%`
- CLF residual > tol: `30.3833%`
- box residual > tol: `0.7544%`

Dominant family among infeasible/binding samples:

- hard CBF dominant: `0.0000%`
- soft CBF dominant: `11.9506%`
- CLF dominant: `86.0648%`
- box dominant: `1.9847%`

Dominant family among actual environment-infeasible samples only:

- hard CBF dominant: `0.0000%`
- soft CBF dominant: `0.3236%`
- CLF dominant: `9.2233%`
- box dominant: `90.4531%`

Dominant family across all samples:

- hard CBF dominant: `53.2849%`
- soft CBF dominant: `10.5115%`
- CLF dominant: `35.2869%`
- box dominant: `0.9167%`

## Physical Distance And D_t

- Mean physical hard-barrier h over all samples: `2.544768`
- Min physical hard-barrier h over all samples: `-0.102364`
- Mean physical hard-barrier h when infeasible: `11.175417`
- Min physical hard-barrier h when infeasible: `0.175086`
- Mean obstacle distance: `1.447560 m`
- Min obstacle distance: `0.185839 m`
- Mean D_t used: `6.788087`
- Mean D_t_curr: `18.761320`
- Mean D_t_floor: `0.143381`
- Mean D_t / |h| ratio: `3.311014`
- Mean D_t / actual-wind-only bound ratio: `0.229817`
- Mean D_t cap ratio current: `3.780334`
- Soft-clamp transition rate: `97.8479%`
- Hard-cap binding rate: `95.9900%`

## CLF Cost Audit

- CLF cost active rate, t_clf > tol, diagnostic only: `80.9534%`
- CLF cost mean when active: `8.348593`
- CLF cost p95 when active: `21.054308`
- Mean t_clf: `6.758467`
- Max t_clf: `111.405693`
- Old V12 CLF residual active rate reference: `~94%`

## HOCBF Low-Speed Check

- Mean relative speed: `1.558225 m/s`
- Fraction with relative speed < 0.1 m/s: `0.4810%`
- Mean |psi1|: `12.379719`
- Mean |psi2|: `32.418221`
- Mean |psi2| at rel_speed < 0.1 m/s: `9.588888`
...
1. `Suspect 2: D_t over-conservative vs wind/h` score `0.6622`
2. `Suspect 3: low-speed HOCBF numerical fragility` score `0.1918`
...
- Required hard-cap binding < 15%: `FAIL`
- Required soft-clamp transition rate in [15%, 50%]: `FAIL`
- Overall V17.5 math gate: `FAIL`
