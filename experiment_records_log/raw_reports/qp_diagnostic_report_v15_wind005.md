...
- Feasibility rate: `99.2432%`
- Infeasibility rate: `0.7568%`
- Infeasible samples: `620 / 81920`
...
- soft CBF residual > tol: `4.7424%`
- CLF residual > tol: `30.5225%`
- box residual > tol: `0.7568%`

Dominant family among infeasible/binding samples:

- hard CBF dominant: `0.0000%`
- soft CBF dominant: `11.0284%`
- CLF dominant: `87.0130%`
- box dominant: `1.9585%`
...
- CLF dominant: `11.2903%`
- box dominant: `88.7097%`

Dominant family across all samples:

- hard CBF dominant: `54.2432%`
- soft CBF dominant: `9.2896%`
- CLF dominant: `35.5420%`
- box dominant: `0.9253%`

## Physical Distance And D_t

- Mean physical hard-barrier h over all samples: `2.556116`
- Min physical hard-barrier h over all samples: `-0.102364`
- Mean physical hard-barrier h when infeasible: `11.222527`
- Min physical hard-barrier h when infeasible: `0.775706`
- Mean obstacle distance: `1.447123 m`
- Min obstacle distance: `0.185839 m`
- Mean D_t used: `1.276147`
- Mean D_t_curr: `1.449068`
- Mean D_t_floor: `0.143347`
- Mean D_t / |h| ratio: `0.963256`
- Mean D_t / actual-wind-only bound ratio: `0.218401`
- D_t cap active rate: `36.2073%`

## CLF Cost Audit

- CLF cost active rate, t_clf > tol, diagnostic only: `80.5457%`
- CLF cost mean when active: `8.124710`
- CLF cost p95 when active: `20.611189`
- Mean t_clf: `6.544101`
- Max t_clf: `98.140320`
...
- Mean relative speed: `1.569172 m/s`
- Fraction with relative speed < 0.1 m/s: `0.4785%`
- Mean |psi1|: `12.450697`
- Mean |psi2|: `32.927185`
- Mean |psi2| at rel_speed < 0.1 m/s: `9.519600`
...
1. `Suspect 2: D_t over-conservative vs wind/h` score `0.1927`
