...
- soft CBF residual > tol: `4.9121%`
- CLF residual > tol: `30.3308%`
- box residual > tol: `0.7434%`

Dominant family among infeasible/binding samples:

- hard CBF dominant: `0.0000%`
- soft CBF dominant: `11.5812%`
- CLF dominant: `86.4832%`
- box dominant: `1.9356%`
...
- CLF dominant: `10.8374%`
- box dominant: `89.1626%`

Dominant family across all samples:

- hard CBF dominant: `54.1162%`
- soft CBF dominant: `9.6558%`
- CLF dominant: `35.3345%`
- box dominant: `0.8936%`

## Physical Distance And D_t

- Mean physical hard-barrier h over all samples: `2.549284`
- Min physical hard-barrier h over all samples: `-0.102364`
- Mean physical hard-barrier h when infeasible: `11.406180`
- Min physical hard-barrier h when infeasible: `1.244252`
- Mean obstacle distance: `1.446566 m`
- Min obstacle distance: `0.185839 m`
- Mean D_t used: `3.098072`
- Mean D_t_curr: `5.216573`
- Mean D_t_floor: `0.143292`
- Mean D_t / |h| ratio: `1.761607`
- Mean D_t / actual-wind-only bound ratio: `0.457479`
- Mean D_t cap ratio current: `2.188559`
- Soft-clamp transition rate: `84.3958%`
- Hard-cap binding rate: `78.0908%`

## CLF Cost Audit

- CLF cost active rate, t_clf > tol, diagnostic only: `80.6165%`
- CLF cost mean when active: `8.202323`
- CLF cost p95 when active: `20.654736`
- Mean t_clf: `6.612422`
- Max t_clf: `101.919403`
- Old V12 CLF residual active rate reference: `~94%`

## HOCBF Low-Speed Check

- Mean relative speed: `1.565356 m/s`
- Fraction with relative speed < 0.1 m/s: `0.4797%`
- Mean |psi1|: `12.412476`
- Mean |psi2|: `32.728878`
- Mean |psi2| at rel_speed < 0.1 m/s: `9.449756`
...
1. `Suspect 2: D_t over-conservative vs wind/h` score `0.3523`
2. `Suspect 3: low-speed HOCBF numerical fragility` score `0.1890`
...
- Required D_t / |h| in [1.3, 1.8]: `PASS`
